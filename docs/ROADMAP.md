...
>
> **最后更新**: 2026-07-09（追加大纲章节跨卷拖动；此前追加物品栏提取范围优化、已写正文参与卷纲/章纲生成、状态卡/物品栏职责澄清方案、社区反馈待开发批次：版本号显示滞后、题材包卷纲参数缺失、JSON 导入后卡加载、角色关系保存反馈异常、长文本编辑滚动失焦、世界起源/力量体系上下文不贯通、上下文窗口配置保存感知异常、章节正文采纳后列表/导出仍为空等；施工权威见 MASTER-BLUEPRINT）
