...
- **27.1-d** 🟡 第一批入口已接入（2026-07-11）：`dispatchAgentIntent` 将灵感反推、角色新建/补全、大纲卷章生成、正文生成/续写/扩写/润色/去 AI 味/按审校报告修改连到右侧 Agent Dock，并携带项目/世界/章节/实体/字段/选区作用域；其余 AI 入口继续按模块迁移
