...
| `worldview.dimension` | `src/components/worldview/WorldviewHumanityPanel.tsx:255`<br/>`src/components/worldview/WorldviewNaturalPanel.tsx:288`<br/>`src/components/worldview/WorldviewOriginPanel.tsx:306` |
| `worldview.divine` | `src/components/worldview/WorldviewOriginPanel.tsx:415` |
| `worldview.divine.split` | `src/components/worldview/WorldviewOriginPanel.tsx:439` |
